...
from circuitid-python import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationJson = Phoneoutboundruleactions


request_body_phoneoutboundruleactions = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_phone_outbound_rule_action_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_phoneoutboundruleactions.serialize(body, content_type)

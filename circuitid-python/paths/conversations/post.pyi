...
# body param
SchemaForRequestBodyApplicationJson = Conversations


request_body_conversations = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_conversation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_conversations.serialize(body, content_type)

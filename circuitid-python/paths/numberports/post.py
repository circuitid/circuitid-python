...
# body param
SchemaForRequestBodyApplicationJson = Numberports


request_body_numberports = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_number_port_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_numberports.serialize(body, content_type)
...
class CreateNumberPort(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_number_port(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_number_port(
        ...
        return self._create_number_port_oapg(
            body=body,

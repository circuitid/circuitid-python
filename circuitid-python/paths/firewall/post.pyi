...
# body param
SchemaForRequestBodyApplicationJson = Firewall


request_body_firewall = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_firewall_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_firewall.serialize(body, content_type)
...
class CreateFirewall(BaseApi):
    ...
    def create_firewall(
        ...
        return self._create_firewall_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = Faxaccounts


request_body_faxaccounts = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_fax_account_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_faxaccounts.serialize(body, content_type)
...
class CreateFaxAccount(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_fax_account(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_fax_account(
        ...
        return self._create_fax_account_oapg(
            body=body,

...
SchemaFor404ResponseBodyApplicationJson = ResponseError
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_developer_app_subscription_oapg(
        self,
...
class GetDeveloperAppSubscription(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_developer_app_subscription(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_developer_app_subscription(
        ...
        return self._get_developer_app_subscription_oapg(

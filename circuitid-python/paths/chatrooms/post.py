...
# body param
SchemaForRequestBodyApplicationJson = Chatrooms


request_body_chatrooms = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_chat_room_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_chatrooms.serialize(body, content_type)
...
class CreateChatRoom(BaseApi):
    ...
    def create_chat_room(
        ...
        return self._create_chat_room_oapg(
            body=body,

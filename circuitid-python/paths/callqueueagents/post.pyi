...
# body param
SchemaForRequestBodyApplicationJson = Callqueueagents


request_body_callqueueagents = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_call_queue_agent_oapg(
        self,
    ...
    def _create_call_queue_agent_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_callqueueagents.serialize(body, content_type)
...
class CreateCallQueueAgent(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_call_queue_agent(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_call_queue_agent(
        ...
        return self._create_call_queue_agent_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = Numbers


request_body_numbers = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_number_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_numbers.serialize(body, content_type)
...
class PatchNumber(BaseApi):
    ...
    def patch_number(
        ...
        return self._patch_number_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = Timeschedules


request_body_timeschedules = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_time_schedule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_timeschedules.serialize(body, content_type)
...
class PatchTimeSchedule(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_time_schedule(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def patch_time_schedule(
        ...
        return self._patch_time_schedule_oapg(
            body=body,

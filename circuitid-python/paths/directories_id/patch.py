...
# body param
SchemaForRequestBodyApplicationJson = Directories


request_body_directories = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_directorie_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_directories.serialize(body, content_type)

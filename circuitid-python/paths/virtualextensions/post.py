...
# body param
SchemaForRequestBodyApplicationJson = Virtualextensions


request_body_virtualextensions = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_virtual_extension_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_virtualextensions.serialize(body, content_type)

...
# body param
SchemaForRequestBodyApplicationJson = Menus


request_body_menus = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_menu_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_menus.serialize(body, content_type)

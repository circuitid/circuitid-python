...
# body param
SchemaForRequestBodyApplicationJson = Developerapps


request_body_developerapps = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_developer_app_oapg(
        self,
    ...
    def _create_developer_app_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_developerapps.serialize(body, content_type)
...
class CreateDeveloperApp(BaseApi):
    ...
    def create_developer_app(
        ...
        return self._create_developer_app_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = Acceptedsenders


request_body_acceptedsenders = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_accepted_sender_oapg(
        self,
    ...
    def _create_accepted_sender_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_acceptedsenders.serialize(body, content_type)
...
class CreateAcceptedSender(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def create_accepted_sender(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def create_accepted_sender(
        ...
        return self._create_accepted_sender_oapg(
            body=body,

...
from circuitid-python.paths.numberports.post import CreateNumberPort
from circuitid-python.paths.numberports.get import FindNumberPorts
from circuitid-python.paths.numberports_id.get import GetNumberPort
from circuitid-python.paths.numberports_id.patch import PatchNumberPort


class NumberPortsApi(
    CreateNumberPort,
    FindNumberPorts,
    GetNumberPort,
    PatchNumberPort,

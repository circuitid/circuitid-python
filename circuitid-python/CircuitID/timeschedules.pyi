...
class Timeschedules(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class timezone(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        ...
                        "America/Ciudad_Juarez": "AMERICA_CIUDAD_JUAREZ",
                ...
                @schemas.classproperty
                def AMERICA_CIUDAD_JUAREZ(cls):
                    return cls("America/Ciudad_Juarez")
                ...
                @schemas.classproperty
                def PACIFIC_KANTON(cls):
                    return cls("Pacific/Kanton")
            ...
            sunday = schemas.AnyTypeSchema
            monday = schemas.AnyTypeSchema
            tuesday = schemas.AnyTypeSchema
            wednesday = schemas.AnyTypeSchema
            thursday = schemas.AnyTypeSchema
            friday = schemas.AnyTypeSchema
            saturday = schemas.AnyTypeSchema
            __annotations__ = {
                "name": name,
                "timezone": timezone,
                "sunday": sunday,
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        sunday: typing.Union[MetaOapg.properties.sunday, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        saturday: typing.Union[MetaOapg.properties.saturday, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        tuesday: typing.Union[MetaOapg.properties.tuesday, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        friday: typing.Union[MetaOapg.properties.friday, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        thursday: typing.Union[MetaOapg.properties.thursday, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        wednesday: typing.Union[MetaOapg.properties.wednesday, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        monday: typing.Union[MetaOapg.properties.monday, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Timeschedules':
        return super().__new__(

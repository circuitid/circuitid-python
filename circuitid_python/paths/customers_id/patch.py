...
# body param
SchemaForRequestBodyApplicationJson = Customers


request_body_customers = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_customer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_customers.serialize(body, content_type)
...
class PatchCustomer(BaseApi):
    ...
    def patch_customer(
        ...
        return self._patch_customer_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = CallqueuesCreateOrPatch


request_body_callqueues_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_call_queue_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_callqueues_create_or_patch.serialize(body, content_type)
...
class PatchCallQueue(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def patch_call_queue(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def patch_call_queue(
        ...
        return self._patch_call_queue_oapg(
            body=body,

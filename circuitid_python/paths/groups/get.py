        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Groups']:
                        return Groups
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Groups'], typing.List['Groups']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Groups':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,

        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Menus']:
                        return Menus
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Menus'], typing.List['Menus']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Menus':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,

...
# body param
SchemaForRequestBodyApplicationJson = MenusCreateOrPatch


request_body_menus_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_menu_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_menus_create_or_patch.serialize(body, content_type)

...
# body param
SchemaForRequestBodyApplicationJson = Usertokens


request_body_usertokens = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_user_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_usertokens.serialize(body, content_type)
...
class CreateUserToken(BaseApi):
    ...
    def create_user_token(
        ...
        return self._create_user_token_oapg(
            body=body,

        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Usertokens']:
                        return Usertokens
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Usertokens'], typing.List['Usertokens']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Usertokens':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindUserTokens(BaseApi):
    ...
    def find_user_tokens(
        ...
        return self._find_user_tokens_oapg(

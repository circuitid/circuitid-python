...
# body param
SchemaForRequestBodyApplicationJson = UsertokensCreateOrPatch


request_body_usertokens_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_user_token_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_usertokens_create_or_patch.serialize(body, content_type)

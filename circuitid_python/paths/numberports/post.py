...
# body param
SchemaForRequestBodyApplicationJson = NumberportsCreateOrPatch


request_body_numberports_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_number_port_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_numberports_create_or_patch.serialize(body, content_type)

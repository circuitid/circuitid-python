        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Holidays']:
                        return Holidays
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Holidays'], typing.List['Holidays']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Holidays':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindHolidays(BaseApi):
    ...
    def find_holidays(
        ...
        return self._find_holidays_oapg(

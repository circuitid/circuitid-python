        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Clients']:
                        return Clients
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Clients'], typing.List['Clients']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Clients':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindClients(BaseApi):
    ...
    def find_clients(
        ...
        return self._find_clients_oapg(

        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Invoiceitems']:
                        return Invoiceitems
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Invoiceitems'], typing.List['Invoiceitems']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Invoiceitems':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindInvoiceItems(BaseApi):
    ...
    def find_invoice_items(
        ...
        return self._find_invoice_items_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = ConversationmessagesCreateOrPatch


request_body_conversationmessages_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_conversation_message_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_conversationmessages_create_or_patch.serialize(body, content_type)

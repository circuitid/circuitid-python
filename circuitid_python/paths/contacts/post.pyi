...
# body param
SchemaForRequestBodyApplicationJson = ContactsCreateOrPatch


request_body_contacts_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_contact_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_contacts_create_or_patch.serialize(body, content_type)
...
class CreateContact(BaseApi):
    ...
    def create_contact(
        ...
        return self._create_contact_oapg(
            body=body,

        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Contacts']:
                        return Contacts
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Contacts'], typing.List['Contacts']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Contacts':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindContacts(BaseApi):
    ...
    def find_contacts(
        ...
        return self._find_contacts_oapg(

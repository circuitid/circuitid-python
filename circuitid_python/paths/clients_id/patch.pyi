...
# body param
SchemaForRequestBodyApplicationJson = ClientsCreateOrPatch


request_body_clients_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_client_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_clients_create_or_patch.serialize(body, content_type)
...
class PatchClient(BaseApi):
    ...
    def patch_client(
        ...
        return self._patch_client_oapg(
            body=body,

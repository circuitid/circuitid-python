...
# body param
SchemaForRequestBodyApplicationJson = Clients


request_body_clients = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_client_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_clients.serialize(body, content_type)

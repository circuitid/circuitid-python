...
# body param
SchemaForRequestBodyApplicationJson = CallqueueagentsCreateOrPatch


request_body_callqueueagents_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_call_queue_agent_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_callqueueagents_create_or_patch.serialize(body, content_type)

        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Callqueueagents']:
                        return Callqueueagents
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Callqueueagents'], typing.List['Callqueueagents']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Callqueueagents':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_call_queue_agents_oapg(
        self,
...
class FindCallQueueAgents(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def find_call_queue_agents(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def find_call_queue_agents(
        ...
        return self._find_call_queue_agents_oapg(

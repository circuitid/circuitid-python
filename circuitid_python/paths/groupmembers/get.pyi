        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Groupmembers']:
                        return Groupmembers
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Groupmembers'], typing.List['Groupmembers']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Groupmembers':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindGroupMembers(BaseApi):
    ...
    def find_group_members(
        ...
        return self._find_group_members_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = GroupmembersCreateOrPatch


request_body_groupmembers_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_group_member_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_groupmembers_create_or_patch.serialize(body, content_type)
...
class CreateGroupMember(BaseApi):
    ...
    def create_group_member(
        ...
        return self._create_group_member_oapg(
            body=body,

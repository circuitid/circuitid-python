...
# body param
SchemaForRequestBodyApplicationJson = Groupmembers


request_body_groupmembers = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_group_member_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_groupmembers.serialize(body, content_type)

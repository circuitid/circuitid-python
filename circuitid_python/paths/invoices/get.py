        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Invoices']:
                        return Invoices
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Invoices'], typing.List['Invoices']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Invoices':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindInvoices(BaseApi):
    ...
    def find_invoices(
        ...
        return self._find_invoices_oapg(

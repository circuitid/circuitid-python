...
# body param
SchemaForRequestBodyApplicationJson = Messagebrands


request_body_messagebrands = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_message_brand_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_messagebrands.serialize(body, content_type)

        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Customers']:
                        return Customers
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Customers'], typing.List['Customers']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Customers':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindCustomers(BaseApi):
    ...
    def find_customers(
        ...
        return self._find_customers_oapg(

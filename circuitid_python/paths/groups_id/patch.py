...
# body param
SchemaForRequestBodyApplicationJson = GroupsCreateOrPatch


request_body_groups_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_groups_create_or_patch.serialize(body, content_type)

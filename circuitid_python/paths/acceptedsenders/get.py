        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Acceptedsenders']:
                        return Acceptedsenders
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Acceptedsenders'], typing.List['Acceptedsenders']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Acceptedsenders':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_accepted_senders_oapg(
        self,
...
class FindAcceptedSenders(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def find_accepted_senders(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def find_accepted_senders(
        ...
        return self._find_accepted_senders_oapg(

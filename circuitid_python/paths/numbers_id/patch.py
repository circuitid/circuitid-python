...
# body param
SchemaForRequestBodyApplicationJson = NumbersCreateOrPatch


request_body_numbers_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _patch_number_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_numbers_create_or_patch.serialize(body, content_type)

...
# body param
SchemaForRequestBodyApplicationJson = ConversationsCreateOrPatch


request_body_conversations_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_conversation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_conversations_create_or_patch.serialize(body, content_type)
...
class CreateConversation(BaseApi):
    ...
    def create_conversation(
        ...
        return self._create_conversation_oapg(
            body=body,

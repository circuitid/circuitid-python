        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Messagecampaigns']:
                        return Messagecampaigns
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Messagecampaigns'], typing.List['Messagecampaigns']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Messagecampaigns':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,

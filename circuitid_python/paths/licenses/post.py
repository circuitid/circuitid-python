...
# body param
SchemaForRequestBodyApplicationJson = Licenses


request_body_licenses = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_license_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_licenses.serialize(body, content_type)
...
class CreateLicense(BaseApi):
    ...
    def create_license(
        ...
        return self._create_license_oapg(
            body=body,

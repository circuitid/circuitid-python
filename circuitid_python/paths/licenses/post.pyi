...
# body param
SchemaForRequestBodyApplicationJson = LicensesCreateOrPatch


request_body_licenses_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_license_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_licenses_create_or_patch.serialize(body, content_type)

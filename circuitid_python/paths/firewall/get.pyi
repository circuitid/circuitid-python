        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Firewall']:
                        return Firewall
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Firewall'], typing.List['Firewall']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Firewall':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindFirewall(BaseApi):
    ...
    def find_firewall(
        ...
        return self._find_firewall_oapg(

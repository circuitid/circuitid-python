        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Directories']:
                        return Directories
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Directories'], typing.List['Directories']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Directories':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindDirectories(BaseApi):
    ...
    def find_directories(
        ...
        return self._find_directories_oapg(

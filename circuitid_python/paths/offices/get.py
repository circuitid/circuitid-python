        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Offices']:
                        return Offices
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Offices'], typing.List['Offices']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Offices':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindOffices(BaseApi):
    ...
    def find_offices(
        ...
        return self._find_offices_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = OfficesCreateOrPatch


request_body_offices_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_office_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_offices_create_or_patch.serialize(body, content_type)
...
class CreateOffice(BaseApi):
    ...
    def create_office(
        ...
        return self._create_office_oapg(
            body=body,

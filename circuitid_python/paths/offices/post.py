...
# body param
SchemaForRequestBodyApplicationJson = Offices


request_body_offices = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_office_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_offices.serialize(body, content_type)

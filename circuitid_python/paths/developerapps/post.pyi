...
# body param
SchemaForRequestBodyApplicationJson = DeveloperappsCreateOrPatch


request_body_developerapps_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_developer_app_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_developerapps_create_or_patch.serialize(body, content_type)

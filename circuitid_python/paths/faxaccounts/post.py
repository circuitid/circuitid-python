...
# body param
SchemaForRequestBodyApplicationJson = FaxaccountsCreateOrPatch


request_body_faxaccounts_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_fax_account_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_faxaccounts_create_or_patch.serialize(body, content_type)

...
# body param
SchemaForRequestBodyApplicationJson = Phoneinboundruleactions


request_body_phoneinboundruleactions = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_phone_inbound_rule_action_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_phoneinboundruleactions.serialize(body, content_type)

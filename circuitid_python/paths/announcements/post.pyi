...
# body param
SchemaForRequestBodyApplicationJson = Announcements


request_body_announcements = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_announcement_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_announcements.serialize(body, content_type)
...
class CreateAnnouncement(BaseApi):
    ...
    def create_announcement(
        ...
        return self._create_announcement_oapg(
            body=body,

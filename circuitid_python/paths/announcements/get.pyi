        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Announcements']:
                        return Announcements
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Announcements'], typing.List['Announcements']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Announcements':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindAnnouncements(BaseApi):
    ...
    def find_announcements(
        ...
        return self._find_announcements_oapg(

        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Developerappsubscriptions']:
                        return Developerappsubscriptions
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Developerappsubscriptions'], typing.List['Developerappsubscriptions']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Developerappsubscriptions':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,

...
# body param
SchemaForRequestBodyApplicationJson = AuthenticationCreateOrPatch


request_body_authentication_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_authentication_oapg(
        self,
    ...
    def _create_authentication_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_authentication_create_or_patch.serialize(body, content_type)
...
class CreateAuthentication(BaseApi):
    ...
    def create_authentication(
        ...
        return self._create_authentication_oapg(
            body=body,

        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Numbers']:
                        return Numbers
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Numbers'], typing.List['Numbers']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Numbers':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindNumbers(BaseApi):
    ...
    def find_numbers(
        ...
        return self._find_numbers_oapg(

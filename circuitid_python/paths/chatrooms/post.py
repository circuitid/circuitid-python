...
# body param
SchemaForRequestBodyApplicationJson = ChatroomsCreateOrPatch


request_body_chatrooms_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_chat_room_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_chatrooms_create_or_patch.serialize(body, content_type)

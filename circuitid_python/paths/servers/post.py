...
# body param
SchemaForRequestBodyApplicationJson = Servers


request_body_servers = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_server_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_servers.serialize(body, content_type)
...
class CreateServer(BaseApi):
    ...
    def create_server(
        ...
        return self._create_server_oapg(
            body=body,

        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Servers']:
                        return Servers
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Servers'], typing.List['Servers']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Servers':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindServers(BaseApi):
    ...
    def find_servers(
        ...
        return self._find_servers_oapg(

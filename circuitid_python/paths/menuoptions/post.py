...
# body param
SchemaForRequestBodyApplicationJson = MenuoptionsCreateOrPatch


request_body_menuoptions_create_or_patch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_menu_option_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_menuoptions_create_or_patch.serialize(body, content_type)
...
class CreateMenuOption(BaseApi):
    ...
    def create_menu_option(
        ...
        return self._create_menu_option_oapg(
            body=body,

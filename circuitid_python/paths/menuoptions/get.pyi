        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Menuoptions']:
                        return Menuoptions
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Menuoptions'], typing.List['Menuoptions']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'data':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'Menuoptions':
                    return super().__getitem__(i)
            __annotations__ = {
                "total": total,
                "limit": limit,
...
class FindMenuOptions(BaseApi):
    ...
    def find_menu_options(
        ...
        return self._find_menu_options_oapg(

...
class Numberports(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["numbers", "name", "type", "typeOfService", "authorizedPerson", "desiredDueDate", "accountNumber", "accountPhoneNumber", "office", "invoice", "status", "destinationType", "e911", "destination", "ref", "callForwardingDestination", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["numbers", "name", "type", "typeOfService", "authorizedPerson", "desiredDueDate", "accountNumber", "accountPhoneNumber", "office", "invoice", "status", "destinationType", "e911", "destination", "ref", "callForwardingDestination", ], str]):

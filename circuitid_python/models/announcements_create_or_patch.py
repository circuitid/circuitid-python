...
class AnnouncementsCreateOrPatch(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "type", "attachments", "voice", "text", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "type", "attachments", "voice", "text", ], str]):

...
class ConversationmessagesCreateOrPatch(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["conversation", "text", "attachments", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["conversation", "text", "attachments", ], str]):

...
class Timeschedules(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            sunday = schemas.DictSchema
            monday = schemas.DictSchema
            tuesday = schemas.DictSchema
            wednesday = schemas.DictSchema
            thursday = schemas.DictSchema
            friday = schemas.DictSchema
            saturday = schemas.DictSchema
            __annotations__ = {
                "name": name,
                "timezone": timezone,
                "sunday": sunday,

...
class Faxaccounts(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            inboundNotification = schemas.AnyTypeSchema
            outboundNotification = schemas.AnyTypeSchema
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        inboundNotification: typing.Union[MetaOapg.properties.inboundNotification, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        outboundNotification: typing.Union[MetaOapg.properties.outboundNotification, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,

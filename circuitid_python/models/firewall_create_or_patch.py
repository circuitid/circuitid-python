...
class FirewallCreateOrPatch(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "type", "target", "param", "description", "direction", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "type", "target", "param", "description", "direction", "status", ], str]):

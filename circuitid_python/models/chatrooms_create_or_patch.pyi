...
class ChatroomsCreateOrPatch(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "avatar", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "avatar", ], str]):

...
class Customers(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            callForwardingCallLimit = schemas.Int32Schema
            supportUserId = schemas.StrSchema
            automaticRefillAmount = schemas.Int32Schema
            lowBalanceAlertAmount = schemas.Int32Schema
            lowBalanceAlertAt = schemas.DateTimeSchema
            lowBalanceAlertCount = schemas.Int32Schema
            lastAutomaticRefillInvoice = schemas.StrSchema
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        callForwardingCallLimit: typing.Union[MetaOapg.properties.callForwardingCallLimit, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ...
        lowBalanceAlertAt: typing.Union[MetaOapg.properties.lowBalanceAlertAt, str, datetime, schemas.Unset] = schemas.unset,
        lowBalanceAlertCount: typing.Union[MetaOapg.properties.lowBalanceAlertCount, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        lastAutomaticRefillInvoice: typing.Union[MetaOapg.properties.lastAutomaticRefillInvoice, str, schemas.Unset] = schemas.unset,
        ...
        callDebug: typing.Union[MetaOapg.properties.callDebug, decimal.Decimal, int, schemas.Unset] = schemas.unset,

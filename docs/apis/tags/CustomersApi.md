<a id="__pageTop"></a>
# circuitid_python.rest.tags.customers_api.CustomersApi

All URIs are relative to *https://cloud9.circuitid.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_customer**](#create_customer) | **post** /customers | Create a new object
[**find_customers**](#find_customers) | **get** /customers | Find multiple objects
[**get_customer**](#get_customer) | **get** /customers/{id} | Get object by id
[**patch_customer**](#patch_customer) | **patch** /customers/{id} | Patch object&#x27;s data
[**remove_customer**](#remove_customer) | **delete** /customers/{id} | Delete object by id
...
from circuitid_python.rest.tags import customers_api
from circuitid_python.CircuitIDModel.customers import Customers
...
with circuitid_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling CustomersApi->find_customers: %s\n" % e)
```
### Parameters
...
# **get_customer**
<a id="get_customer"></a>
> bool, date, datetime, dict, float, int, list, str, none_type get_customer(id)
...
#### get_customer.ApiResponseFor405
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
# **remove_customer**
<a id="remove_customer"></a>
> bool, date, datetime, dict, float, int, list, str, none_type remove_customer(id)
...
with circuitid_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete object by id
        api_response = api_instance.remove_customer(
            path_params=path_params,
        )
        pprint(api_response)
    except circuitid_python.ApiException as e:
        print("Exception when calling CustomersApi->remove_customer: %s\n" % e)
```
### Parameters

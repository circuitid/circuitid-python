<a id="__pageTop"></a>
# circuitid-python.CircuitID.tags.number_ports_api.NumberPortsApi
...
[**patch_number_port**](#patch_number_port) | **patch** /numberports/{id} | Patch object&#x27;s data

# **create_number_port**
<a id="create_number_port"></a>
> bool, date, datetime, dict, float, int, list, str, none_type create_number_port(numberports)
...
from circuitid-python.CircuitID.tags import number_ports_api
...
------------- | ------------- | -------------
[**Numberports**](../../models/Numberports.md) |  | 
...
400 | [ApiResponseFor400](#create_number_port.ApiResponseFor400) | 
401 | [ApiResponseFor401](#create_number_port.ApiResponseFor401) | 
403 | [ApiResponseFor403](#create_number_port.ApiResponseFor403) | 
405 | [ApiResponseFor405](#create_number_port.ApiResponseFor405) | 
406 | [ApiResponseFor406](#create_number_port.ApiResponseFor406) | 
408 | [ApiResponseFor408](#create_number_port.ApiResponseFor408) | 
429 | [ApiResponseFor429](#create_number_port.ApiResponseFor429) | 
500 | [ApiResponseFor500](#create_number_port.ApiResponseFor500) | 
503 | [ApiResponseFor503](#create_number_port.ApiResponseFor503) | 
...
> bool, date, datetime, dict, float, int, list, str, none_type find_number_ports()
...
400 | [ApiResponseFor400](#find_number_ports.ApiResponseFor400) | 
401 | [ApiResponseFor401](#find_number_ports.ApiResponseFor401) | 
403 | [ApiResponseFor403](#find_number_ports.ApiResponseFor403) | 
405 | [ApiResponseFor405](#find_number_ports.ApiResponseFor405) | 
406 | [ApiResponseFor406](#find_number_ports.ApiResponseFor406) | 
408 | [ApiResponseFor408](#find_number_ports.ApiResponseFor408) | 
429 | [ApiResponseFor429](#find_number_ports.ApiResponseFor429) | 
500 | [ApiResponseFor500](#find_number_ports.ApiResponseFor500) | 
503 | [ApiResponseFor503](#find_number_ports.ApiResponseFor503) | 
...
400 | [ApiResponseFor400](#get_number_port.ApiResponseFor400) | 
401 | [ApiResponseFor401](#get_number_port.ApiResponseFor401) | 
403 | [ApiResponseFor403](#get_number_port.ApiResponseFor403) | 
404 | [ApiResponseFor404](#get_number_port.ApiResponseFor404) | Not Found
405 | [ApiResponseFor405](#get_number_port.ApiResponseFor405) | 
406 | [ApiResponseFor406](#get_number_port.ApiResponseFor406) | 
408 | [ApiResponseFor408](#get_number_port.ApiResponseFor408) | 
429 | [ApiResponseFor429](#get_number_port.ApiResponseFor429) | 
500 | [ApiResponseFor500](#get_number_port.ApiResponseFor500) | 
503 | [ApiResponseFor503](#get_number_port.ApiResponseFor503) | 
...
# **patch_number_port**
<a id="patch_number_port"></a>
> bool, date, datetime, dict, float, int, list, str, none_type patch_number_port(idnumberports)
...
with circuitid-python.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch object's data
        api_response = api_instance.patch_number_port(
            path_params=path_params,
            body=body,
        )
        pprint(api_response)
    except circuitid-python.ApiException as e:
        print("Exception when calling NumberPortsApi->patch_number_port: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
n/a | api_client.ApiResponseWithoutDeserialization | When skip_deserialization is True this response is returned
200 | [ApiResponseFor200](#patch_number_port.ApiResponseFor200) | A JSON object containing the modified data.
400 | [ApiResponseFor400](#patch_number_port.ApiResponseFor400) | 
401 | [ApiResponseFor401](#patch_number_port.ApiResponseFor401) | 
403 | [ApiResponseFor403](#patch_number_port.ApiResponseFor403) | 
405 | [ApiResponseFor405](#patch_number_port.ApiResponseFor405) | 
406 | [ApiResponseFor406](#patch_number_port.ApiResponseFor406) | 
408 | [ApiResponseFor408](#patch_number_port.ApiResponseFor408) | 
429 | [ApiResponseFor429](#patch_number_port.ApiResponseFor429) | 
500 | [ApiResponseFor500](#patch_number_port.ApiResponseFor500) | 
503 | [ApiResponseFor503](#patch_number_port.ApiResponseFor503) | 

#### patch_number_port.ApiResponseFor200
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor200ResponseBodyApplicationJson, ] |  |
...
#### patch_number_port.ApiResponseFor400
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### patch_number_port.ApiResponseFor401
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### patch_number_port.ApiResponseFor403
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### patch_number_port.ApiResponseFor405
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### patch_number_port.ApiResponseFor406
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### patch_number_port.ApiResponseFor408
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### patch_number_port.ApiResponseFor429
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### patch_number_port.ApiResponseFor500
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
#### patch_number_port.ApiResponseFor503
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |

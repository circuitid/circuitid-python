...
> bool, date, datetime, dict, float, int, list, str, none_type create_phone_inbound_rule_action(phoneinboundruleactions_create_or_patch)
...
from circuitid_python.models.phoneinboundruleactions_create_or_patch import PhoneinboundruleactionsCreateOrPatch
...
with circuitid_python.ApiClient(configuration) as api_client:
    ...
    body = PhoneinboundruleactionsCreateOrPatch(
        name="name_example",
...
------------- | ------------- | -------------
[**PhoneinboundruleactionsCreateOrPatch**](../../models/PhoneinboundruleactionsCreateOrPatch.md) |  | 
...
> bool, date, datetime, dict, float, int, list, str, none_type patch_phone_inbound_rule_action(idphoneinboundruleactions_create_or_patch)

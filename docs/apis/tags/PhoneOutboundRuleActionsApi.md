<a id="__pageTop"></a>
# circuitid-python.CircuitID.tags.phone_outbound_rule_actions_api.PhoneOutboundRuleActionsApi
...
> bool, date, datetime, dict, float, int, list, str, none_type create_phone_outbound_rule_action(phoneoutboundruleactions)
...
from circuitid-python.CircuitID.tags import phone_outbound_rule_actions_api
...
------------- | ------------- | -------------
[**Phoneoutboundruleactions**](../../models/Phoneoutboundruleactions.md) |  | 
...
> bool, date, datetime, dict, float, int, list, str, none_type patch_phone_outbound_rule_action(idphoneoutboundruleactions)

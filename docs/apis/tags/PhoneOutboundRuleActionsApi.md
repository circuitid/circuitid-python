<a id="__pageTop"></a>
# circuitid_python.api.tags.phone_outbound_rule_actions_api.PhoneOutboundRuleActionsApi

All URIs are relative to *https://cloud9.circuitid.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_phone_outbound_rule_action**](#create_phone_outbound_rule_action) | **post** /phoneoutboundruleactions | Create a new object
[**find_phone_outbound_rule_actions**](#find_phone_outbound_rule_actions) | **get** /phoneoutboundruleactions | Find multiple objects
[**get_phone_outbound_rule_action**](#get_phone_outbound_rule_action) | **get** /phoneoutboundruleactions/{id} | Get object by id
[**patch_phone_outbound_rule_action**](#patch_phone_outbound_rule_action) | **patch** /phoneoutboundruleactions/{id} | Patch object&#x27;s data
[**remove_phone_outbound_rule_action**](#remove_phone_outbound_rule_action) | **delete** /phoneoutboundruleactions/{id} | Delete object by id

# **create_phone_outbound_rule_action**
<a id="create_phone_outbound_rule_action"></a>
> bool, date, datetime, dict, float, int, list, str, none_type create_phone_outbound_rule_action(phoneoutboundruleactions_create_or_patch)
...
from circuitid_python.models.phoneoutboundruleactions_create_or_patch import PhoneoutboundruleactionsCreateOrPatch
...
with circuitid_python.ApiClient(configuration) as api_client:
    ...
    body = PhoneoutboundruleactionsCreateOrPatch(
        name="name_example",
        group="group_example",
    ...
    try:
        ...
        print("Exception when calling PhoneOutboundRuleActionsApi->create_phone_outbound_rule_action: %s\n" % e)
```
### Parameters
...
------------- | ------------- | -------------
[**PhoneoutboundruleactionsCreateOrPatch**](../../models/PhoneoutboundruleactionsCreateOrPatch.md) |  | 
...
with circuitid_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Find multiple objects
        api_response = api_instance.find_phone_outbound_rule_actions(
            query_params=query_params,
        )
        pprint(api_response)
    except circuitid_python.ApiException as e:
        print("Exception when calling PhoneOutboundRuleActionsApi->find_phone_outbound_rule_actions: %s\n" % e)
```
### Parameters
...
<a id="get_phone_outbound_rule_action"></a>
> bool, date, datetime, dict, float, int, list, str, none_type get_phone_outbound_rule_action(id)
...
with circuitid_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get object by id
        api_response = api_instance.get_phone_outbound_rule_action(
            path_params=path_params,
        )
        pprint(api_response)
    except circuitid_python.ApiException as e:
        print("Exception when calling PhoneOutboundRuleActionsApi->get_phone_outbound_rule_action: %s\n" % e)
```
### Parameters
...
#### get_phone_outbound_rule_action.ApiResponseFor405
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | typing.Union[SchemaFor405ResponseBodyApplicationJson, ] |  |
...
<a id="patch_phone_outbound_rule_action"></a>
> bool, date, datetime, dict, float, int, list, str, none_type patch_phone_outbound_rule_action(idphoneoutboundruleactions_create_or_patch)
...
with circuitid_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling PhoneOutboundRuleActionsApi->patch_phone_outbound_rule_action: %s\n" % e)
```
### Parameters
...
<a id="remove_phone_outbound_rule_action"></a>
> bool, date, datetime, dict, float, int, list, str, none_type remove_phone_outbound_rule_action(id)
...
with circuitid_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete object by id
        api_response = api_instance.remove_phone_outbound_rule_action(
            path_params=path_params,
        )
        pprint(api_response)
    except circuitid_python.ApiException as e:
        print("Exception when calling PhoneOutboundRuleActionsApi->remove_phone_outbound_rule_action: %s\n" % e)
```
### Parameters

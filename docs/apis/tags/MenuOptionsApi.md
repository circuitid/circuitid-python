<a id="__pageTop"></a>
# circuitid-python.CircuitID.tags.menu_options_api.MenuOptionsApi

All URIs are relative to *https://cloud9.circuitid.com*

Method | HTTP request | Description
------------- | ------------- | -------------
[**create_menu_option**](#create_menu_option) | **post** /menuoptions | Create a new object
[**find_menu_options**](#find_menu_options) | **get** /menuoptions | Find multiple objects
[**get_menu_option**](#get_menu_option) | **get** /menuoptions/{id} | Get object by id
[**patch_menu_option**](#patch_menu_option) | **patch** /menuoptions/{id} | Patch object&#x27;s data
[**remove_menu_option**](#remove_menu_option) | **delete** /menuoptions/{id} | Delete object by id
...
from circuitid-python.CircuitID.tags import menu_options_api
...
with circuitid-python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling MenuOptionsApi->create_menu_option: %s\n" % e)
```
### Parameters
...
with circuitid-python.ApiClient(configuration) as api_client:
    ...
    try:
        # Find multiple objects
        api_response = api_instance.find_menu_options(
            query_params=query_params,
        )
        pprint(api_response)
    except circuitid-python.ApiException as e:
        print("Exception when calling MenuOptionsApi->find_menu_options: %s\n" % e)
```
### Parameters
...
# **get_menu_option**
<a id="get_menu_option"></a>
> bool, date, datetime, dict, float, int, list, str, none_type get_menu_option(id)
...
with circuitid-python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get object by id
        api_response = api_instance.get_menu_option(
            path_params=path_params,
        )
        pprint(api_response)
    except circuitid-python.ApiException as e:
        print("Exception when calling MenuOptionsApi->get_menu_option: %s\n" % e)
```
### Parameters
...
#### get_menu_option.ApiResponseFor405
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
with circuitid-python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling MenuOptionsApi->patch_menu_option: %s\n" % e)
```
### Parameters
...
# **remove_menu_option**
<a id="remove_menu_option"></a>
> bool, date, datetime, dict, float, int, list, str, none_type remove_menu_option(id)
...
with circuitid-python.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete object by id
        api_response = api_instance.remove_menu_option(
            path_params=path_params,
        )
        pprint(api_response)
    except circuitid-python.ApiException as e:
        print("Exception when calling MenuOptionsApi->remove_menu_option: %s\n" % e)
```
### Parameters

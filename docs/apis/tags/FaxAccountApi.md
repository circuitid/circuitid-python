<a id="__pageTop"></a>
# circuitid-python.CircuitID.tags.fax_account_api.FaxAccountApi
...
from circuitid-python.CircuitID.tags import fax_account_api
...
# **get_fax_account**
<a id="get_fax_account"></a>
> bool, date, datetime, dict, float, int, list, str, none_type get_fax_account(id)
...
with circuitid-python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get object by id
        api_response = api_instance.get_fax_account(
...
#### get_fax_account.ApiResponseFor405
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
response | urllib3.HTTPResponse | Raw response |
body | Unset | body was not defined |
...
# **remove_fax_account**
<a id="remove_fax_account"></a>
> bool, date, datetime, dict, float, int, list, str, none_type remove_fax_account(id)
...
with circuitid-python.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete object by id
        api_response = api_instance.remove_fax_account(
            path_params=path_params,
        )
        pprint(api_response)
    except circuitid-python.ApiException as e:
